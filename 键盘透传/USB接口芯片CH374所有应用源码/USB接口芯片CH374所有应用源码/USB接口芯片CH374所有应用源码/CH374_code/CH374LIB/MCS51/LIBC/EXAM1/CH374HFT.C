...
/* 用于以下情况的MCS51单片机
   1. 非总线MCS51单片机,用普通I/O引脚模拟8位并行总线读写,与CH374之间采用并口连接
   2. 单片机与CH374之间采用SPI串口连接
*/
...
*/
/* 未连接CH374的INT#引脚, 采用查询方式处理, 适用于所有MCS51单片机 */


/* C51   CH374HFT.C */
/* LX51  CH374HFT.OBJ , CH374HFC.LIB */
/* OHX51 CH374HFT */
...
UINT8X	my_buffer[ 0x7000 ];			/* 外部RAM的文件数据缓冲区 */
...
/* 列出文件 */
			...
			else pCodeStr = "\\C51\\CH*";  /* CH374HFT.C文件不存在则列出\C51子目录下的以CH开头的文件 */
			printf( "List file %s\n", pCodeStr );
